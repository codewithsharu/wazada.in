...
const FilterSidebar = () => {
    ...
    const clearFilters = () => {
        ...
        setPriceRange([0, 100]);
        setSearchParam({});
        navigate('/collections/all'); // Reset URL to base path
    };
    ...
    useEffect(() => {
        ...
        // Set default category to 'All' if no category is specified in URL
        setFilter({
    ...
    const updateURLParams = (newFilters) => {
        ...
        Object.keys(newFilters).forEach((key) => {
            ...
            } else if (newFilters[key] && newFilters[key] !== 'All') { // Don't add 'All' to URL params
